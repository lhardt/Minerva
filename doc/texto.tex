...
\begin{document}
	...
	\section{FUNDAMENTAÇÃO TEÓRICA}
		...
		\subsection{Descrição Formal do Cronograma}
			...
			\begin{enumerate}
				\item Nenhum professor pode ministrar duas aulas em um único período;
				\item Nenhuma turma pode assistir a duas aulas em um único período;
				...
				\item Uma sala pode ser ocupada, no máximo, por uma aula em qualquer dado período;
			...
			\begin{enumerate}
				...
				\item Algumas disciplinas têm preferência quanto ao número de aulas geminadas;
			...
			\begin{enumerate}
				\item O professor deverá ou não ter um conjunto de períodos para a elaboração de suas aulas;
				...
				\item Alguns professores podem ter um número máximo de aulas por dia por grupos de turmas;
				...
				\item Uma sala pode ter disponibilidade limitada durante a um ciclo;
			\end{enumerate}

		\subsection{Soluções Correntemente Utilizadas}
	...
	\section{TRABALHOS RELACIONADOS}
		...
		\scalebox{0.7}{
			\begin{tabular}{| l | c | c | c | c | c | c | c | c | }
				...
				Make Your Timetable & ? & Y & N & ? & N & S & \cite{rel_makeyourtimetable} \\ \hline
	...
	\section{METODOLOGIA}
		...
		\subsection{Modelagem do Sistema}
			...
			É utilizada a estrutura CART (para a criação
