...
\begin{document}
	...
	In der vorliegenden Arbeit, ist das Stundenplanerstellungsproblem untergesucht.
	...
	\section{FUNDAMENTAÇÃO TEÓRICA}
		...
		\subsection{DESCRIÇÃO FORMAL DAS RESTRIÇÕES DO CRONOGRAMA}
			...
			Defina uma escola como uma tupla $S = (C,T,R,P)$, com turmas, professores, salas e períodos, respectivamente.
			Segue então que, para qualquer $c \in C$, $t \in T$, $r \in R$, $p \in P$, temos:
		...
		% \subsection{MODELOS PARA COMPARAÇÃO COM SOLUÇÕES ANTERIORES}
		%
		% 	\lipsum[1]
	...
	\section{TRABALHOS RELACIONADOS}
		...
		\scalebox{0.7}{
			\begin{tabular}{| c | c | c | c | c |}
				...
				Horário Fácil & & & & \\
				\hline
				GridClass http://gridclass.com.br/ \\
				\hline
				Benchmark Timetable &   &    &   &  \\
				\hline
				ASC Timetables &   &    &   &  \\
	...
	\section{METODOLOGIA}
		...
		\subsection{MODELAGEM DO SISTEMA}
			...
			\subsubsection{ALGORITMOS}
				...
				\par Usar alguma aleatoridade depois do primeiro cronograma
