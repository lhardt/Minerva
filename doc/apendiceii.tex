...
\begin{document}
	...
	\section{TRABALHOS RELACIONADOS}
		...
		\begin{table}[htb]
			...
			\scalebox{0.7}{
				\begin{tabular}{| l | c | c | c | c | c | c | c | c | }
					...
					iTimetable          & N & N & N & N & N & \footnotemark& \cite{rel_itimetable}  			\\ \hline
					Lantiv 				& N & N & N & S & \multicolumn{2}{c|}{\footnotemark} & \cite{rel_lantiv}\\ \hline
		...
		\footnotetext{O programa é local, mas os dados ficam na nuvem.}
		\addtocounter{footnote}{1}
		\footnotetext{A grade horária é encomendada}
