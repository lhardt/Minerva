...
WelcomeForm::WelcomeForm(Application * owner) : wxFrame(nullptr, wxID_ANY, "Horário Escolar Minerva", wxPoint(30,30), wxSize(800,600)) {
	...
	wxPanel * m_background = new wxPanel(this, wxID_ANY, wxPoint(0,0), wxSize(800,575));
	m_background->SetBackgroundColour(wxColor(0x29, 0x80, 0xb9));
	...
	wxStaticText * m_title = new wxStaticText(m_background, wxID_ANY,wxT("Horário Escolar Minerva"), wxPoint(20,140), wxSize(300,40));
	m_title->SetForegroundColour(wxColor(0xFF, 0xFF, 0xFF));
	m_title->SetFont(*m_owner->m_title_font);

	wxStaticText * m_description = new wxStaticText(m_background, wxID_ANY,
	...
	wxImage * image = new wxImage(400,400);

	image->AddHandler(new wxPNGHandler);
	image->LoadFile("res/floating.png", wxBITMAP_TYPE_PNG);

	m_image = new wxStaticBitmap(m_background, wxID_ANY, wxBitmap(*image), wxPoint(400,50));
	m_dropdown = new wxComboBox(m_background, wxID_ANY, "Projetos Anteriores", wxPoint(50,260), wxSize(240,30));
	m_button_open = new wxButton(m_background, wxID_ANY, "Abrir", wxPoint(300, 260), wxSize(55,30));
	m_button_import = new wxButton(m_background, wxID_ANY, "Importar", wxPoint(50, 305), wxSize(95,30));
	m_button_delete = new wxButton(m_background, wxID_ANY, "Apagar", wxPoint(155, 305), wxSize(95,30));
	m_button_create = new wxButton(m_background, wxID_ANY, "Criar", wxPoint(260, 305), wxSize(95,30));
