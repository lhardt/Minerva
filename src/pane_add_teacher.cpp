...
AddTeacherPane::AddTeacherPane(Application * owner, wxWindow * parent, wxPoint pos) : wxScrolledWindow(parent, wxID_ANY, pos, wxSize(600,400)){
	...
	wxButton * add_group = new wxButton(this, wxID_ANY, wxT("Adicionar Professor"), wxDefaultPosition, wxSize(180,30));
	add_group->Bind(wxEVT_BUTTON, &AddTeacherPane::OnAddButtonClicked, this);
...
void AddTeacherPane::OnAddButtonClicked(wxCommandEvent & ev){
